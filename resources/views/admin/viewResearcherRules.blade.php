          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>These rules will be used by researchers when adding courses</h2>
...
<div>
  <div>
              <!-- add modal -->
<form method="POST" action="{{ route('admin.researcherRule.add')}}">
  {{ csrf_field() }}
  ...
  <div>
              <!-- edit modal -->
<form method="POST" action="{{ route('admin.researcherRule.edit')}}">
  {{ csrf_field() }}
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
             <button type="submit" class="btn btn-primary">Submit</button>
                ...
                <!-- delete modal -->
<form method="POST" action="{{ route('admin.researcherRule.delete')}}">
  {{ csrf_field() }}
